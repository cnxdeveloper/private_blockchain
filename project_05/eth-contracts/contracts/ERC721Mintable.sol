...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "account is not owner");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId]!=to, "require the given address to not be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        /*require(isApprovedForAll(_tokenOwner[tokenId], msg.sender) || _tokenOwner[tokenId]==msg.sender,
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        if(_exists(tokenId)){
            revert("tokenId already exist");
        }
        if( to==address(0) ){
            revert("address is invalid");
        }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId]==from, "from address is not the owner of the given token");
...
contract CustomERC721Token is ERC721Metadata{
    ...
    //  1) Pass in appropriate values for the inherited ERC721Metadata contract
    //      - make the base token uri: https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/
    constructor () public ERC721Metadata("CNXTOKEN",
                                         "Tokenfpt",
